    ...
    def build_targets(self, p, targets, imgs):
        ...
        for i in range(nl):
            if matching_targets[i] != []:
                ...
                matching_bs[i] = torch.tensor([], device='cpu:0', dtype=torch.int64)
                matching_as[i] = torch.tensor([], device='cpu:0', dtype=torch.int64)
                matching_gjs[i] = torch.tensor([], device='cpu:0', dtype=torch.int64)
                matching_gis[i] = torch.tensor([], device='cpu:0', dtype=torch.int64)
                matching_targets[i] = torch.tensor([], device='cpu:0', dtype=torch.int64)
                matching_anchs[i] = torch.tensor([], device='cpu:0', dtype=torch.int64)
